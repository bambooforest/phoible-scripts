...
```
    ...
    ## $ ISO6393                <chr> "kor", "kor", "kor", "kor", "kor", "kor...
    ...
    ## $ Allophones             <chr> "a", "aː", "ɛ æ", "æː", "e", "eː", "ɤ",...
    ## $ Marginal               <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,...
    ...
    ## $ Name                   <fct> SPA, SPA, SPA, SPA, SPA, SPA, SPA, SPA,...
    ## $ Contributor            <fct> Stanford Phonology Archive, Stanford Ph...
    ## $ Description            <fct> The Stanford Phonology Archive (SPA) wa...
    ## $ Contents               <fct> Phonemes, allophones, tones., Phonemes,...
    ## $ Citation               <fct> spa1979, spa1979, spa1979, spa1979, spa...
    ## $ SourceURL              <fct> , , , , , , , , , , , , , , , , , , , ,...
    ## $ URL                    <fct> https://github.com/phoible/dev/tree/mas...
    ## $ Contribution_ID        <chr> "cho1967;martin1951;martin1954;martinle...
    ## $ Phoneme_description    <chr> "LATIN SMALL LETTER A", "LATIN SMALL LE...
    ## $ Parameter_ID           <chr> "3bff843fa918065aa88e47217358c573", "eb...
