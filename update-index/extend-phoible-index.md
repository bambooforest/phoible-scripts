...
```
    ...
    ## $ Glottocode           <chr> "kore1280", "kett1243", "lakk1252", "kaba12…
    ## $ LanguageName         <chr> "Korean", "Ket", "Lak", "Kabardian", "Georg…
    ## $ Source               <chr> "spa", "spa", "spa", "spa", "spa", "spa", "…
    ## $ family_id            <chr> "kore1284", "yeni1252", "nakh1245", "abkh12…
    ## $ parent_id            <chr> "kore1284", "nort2746", "dagh1238", "circ12…
    ## $ name                 <chr> "Korean", "Ket", "Lak", "Kabardian", "Georg…
    ## $ bookkeeping          <chr> "False", "False", "False", "False", "False"…
    ## $ level                <chr> "language", "language", "language", "langua…
    ## $ status               <chr> "safe", "definitely endangered", "vulnerabl…
    ## $ latitude             <dbl> 37.50000, 63.75510, 42.13280, 43.50820, 41.…
    ## $ longitude            <dbl> 128.00000, 87.54660, 47.08090, 43.39180, 43…
    ...
    ## $ child_dialect_count  <int> 8, 0, 4, 1, 16, 3, 2, 17, 1, 0, 3, 4, 5, 2,…
    ## $ country_ids          <chr> "CN KP KR RU", "RU", "AZ GE KZ RU UA", "RU …
