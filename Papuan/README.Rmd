...
Filter out languages -- note this is not 100% correct according to Harald, i.e., Glottolog Papunesian languages minus Austronesian does not equal Papuan languages exactly, so this is an approximation for exploratory analysis.
