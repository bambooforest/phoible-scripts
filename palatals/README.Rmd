...
This report extracts [palatal consonants](https://en.wikipedia.org/wiki/Palatal_consonant) from [PHOIBLE](https://phoible.org/) [@MoranMcCloy2019].

The output data format is a [CSV](https://en.wikipedia.org/wiki/Comma-separated_values) file with the following columns:
